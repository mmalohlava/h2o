...
public class RandomForestTest extends TestUtil {
  ...
  @org.junit.Test public void kaggle_credit() throws Exception {
    ...
    DRFJob result = hex.rf.DRF.execute(modelKey,cols,val,ntrees,depth,1024,statType,seed, true, null, -1, Sampling.Strategy.RANDOM, 1.0f, null, 0, 0, false, 1, false, null);
